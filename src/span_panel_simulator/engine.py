...
Forked from span-panel-api's simulation module to keep the simulator
fully independent.  Produces ``SpanPanelSnapshot`` objects from YAML
configuration using time-of-day modulation, cycling, solar curves,
